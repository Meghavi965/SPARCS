...
* **Theoretical Robustness Guarantee (Theorem 1):** PyTorch Spectral Normalization enforces a certified local $K$-Lipschitz continuity bound on the composite decision score $\DeltaS\lew_3\frac{K{\pi\Vert{}\mu_\pi\Vert{}_2}+w_2L_\sigma\Vert{}\delta\Vert{}_2$.
