...
* **Theoretical Robustness Guarantee (Theorem 1):** PyTorch Spectral Normalization enforces a certified local $K$-Lipschitz continuity bound on the composite decision score $$\Delta S \le w_3 \frac{K}{\pi \|\mu_\pi\|_2} + w_2 L_\sigma \|\delta\|_2$$
